...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 1. Tạo order object (orderId = "DH" + timestamp, expireAt = +15 phút)
      const order = createOrder(form, cart, totalPrice, totalItems);

      // 2. Lưu vào localStorage (WaitingPaymentPage sẽ đọc)
      saveOrderToStorage(order);

      // 3. Gửi đến n8n webhook (không await blocking — fire & forget)
